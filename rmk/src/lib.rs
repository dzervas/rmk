...
>(
    #[cfg(feature = "col2row")] input_pins: &'a mut [&'a mut In; ROW],
    #[cfg(not(feature = "col2row"))] input_pins: &'a mut [&'a mut In; COL],
    #[cfg(feature = "col2row")] output_pins: &'a mut [&'a mut Out; COL],
    #[cfg(not(feature = "col2row"))] output_pins: &'a mut [&'a mut Out; ROW],
